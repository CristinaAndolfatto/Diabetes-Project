function [DFA] = DFAfeature2(suitableOverlappingDay)

    %% Equally distributed windows from 24h to 15'
    numberOfElements = length(suitableOverlappingDay);
    ...
    for i=D(1:length(D)-2) % to exclude windows of 10' and 5'
        ...
        temp = mat2cell(suitableOverlappingDay,diff([0:timeWindowSize:numberOfElements-1,numberOfElements]));
