...
main_dir="/Users/cristinaandolfatto/Desktop/Università/Collaborazione ricerca_DiabetesClassification/dCGM_data/";
...
%% dCGM table splitting into patients tables and creation of each patient
% csv file
patients_table_path=main_dir+"patients_tables/";
patientsTablesCsvWriting(data_table, patients_table_path);
...
save(char(main_dir+"Subjects.mat"),'subjects','-mat');
save(char(main_dir+"SubjectsID.mat"),'subjects_id','-mat');
...
save([main_dir+"patients_statistics/subjectsWithFeatures.mat"],'subjectsWithFeatures');
...
[D_subjects,P_subjects,H_subjects]=splitSubjectsClasses(subjectsWithFeatures);
...
save(main_dir+"DiabeticSubjects.mat",'D_subjects','-mat');
save(main_dir+"PreDiabeticSubjects.mat",'P_subjects','-mat');
save(main_dir+"HealthySubjects.mat",'H_subjects','-mat');
